    ...
    >
      ...
      <div class="container m-auto flex justify-around items-center">
        <div className="main_menu">
          ...
          <div class="flex justify-center py-1 cursor-pointer	">
            <img src="/assets/YummCloud/Main/play.png" alt="play" />
          </div>

          <div class="flex justify-center py-1 cursor-pointer" onClick={openControlsModal}>
            <img src="/assets/YummCloud/Main/control.png" alt="control" />
          </div>

          <div class="flex justify-center py-1 cursor-pointer" onClick={openGalleryModal}>
            <img src="/assets/YummCloud/Main/gallery.png" alt="gellery" />
          </div>

          <div class="flex justify-center py-1 cursor-pointer" onClick={openAboutModal}>
            <img src="/assets/YummCloud/Main/about.png" alt="about" />
          </div>

          <div class="flex justify-center py-1 cursor-pointer" onClick={openMintModal}>
            <img src="/assets/YummCloud/Main/mint.png" alt="mint" />
          </div>
        </div>
